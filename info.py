...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Cinema_Moviesz')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Cinema_Moviesz')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Cinema_Moviesz')
...
URL = "https://stream-auto.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://stream-auto.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://stream-auto.onrender.com/".format(FQDN)
else:
    URL = "https://stream-auto.onrender.com/".format(FQDN)
